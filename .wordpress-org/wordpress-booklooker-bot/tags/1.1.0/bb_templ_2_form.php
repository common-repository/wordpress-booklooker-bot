    <form style="width:100%; padding:10px; background-color:#ffffff; border:solid 2px #ececec"; name="bookbot2" method="post" action="<?php echo admin_url( "plugins.php?page=bookbotpl" ); ?>">
      ...
      <input name="booklook_uid2" value="<?php echo get_option('booklook_uid2'); ?>" type="text" /></p>       
