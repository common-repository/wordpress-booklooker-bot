    <form style="width:100%; padding:10px; background-color:#ffffff; border:solid 2px #ececec"; name="bookbot1" method="post" action="<?php echo admin_url( "plugins.php?page=bookbotpl" ); ?>">
      ...
      <input name="booklook_uid1" value="<?php echo get_option('booklook_uid1'); ?>" type="text" /></p>       
