    <form id="bookbot2" style="width:100%; padding:10px; background-color:#ffffff; border:solid 2px #ececec;" name="bookbot2" method="post" action="<?php echo admin_url( 'plugins.php?page=bookbotpl' ); ?>">
      ...
      <p><input name="booklook_uid2" value="<?php echo get_option('booklook_uid2'); ?>" type="text" /></p>       
      <p style="font-weight:bold; font-size:120%">Hier deine Produkt-ID (Kategorie) eintragen: </p><input name="prod_id2" value="<?php echo get_option('prod_id2'); ?>" type="text" />
      ...
      <textarea name="booklook_headline2" cols="30" rows="5"><?php echo get_option('booklook_headline2'); ?></textarea><br />
      ...
      <p style="color:red; font-style:italic; font-size:120%">Danach diesen Shortcode: <span style="color:black; font-weight:bold; font-style:normal">[book_bot_short_2]</span> in eine Seite (z. B.: Neue Seite mit Standardtemplate erstellen)<br /> oder in einen Artikel an einer Stelle deiner Wahl einfügen.</p>
      ...
      <?php 
        $radio_checked = get_option('booklook_sparte2');
      ...
      <p><input type="radio" name="booklook_sparte2" value="sparte1ID"<?php echo $radio_checked_sparte1ID; ?> /> = Oberkategorie (sparte1ID)<br />
      <input type="radio" name="booklook_sparte2" value="sparteID"<?php echo $radio_checked_sparteID; ?> /> = Unterkategorie (sparteID)<br />
      <input type="radio" name="booklook_sparte2" value="keine"<?php echo $radio_checked_keine; ?> /> = keine (Standard)</p>
      <p style="font-weight:bold; font-size:120%">Hier Nummer der Sparte1ID oder SparteID eintragen: <p><input name="booklook_sparteID2" value="<?php echo get_option('booklook_sparteID2'); ?>" type="text" />(Nummer der Sparte)<br />
      <input style="color:#1b4a95; font-size:120%; font-weight:bold; background-color:#ececec; border-style:outline; border-width:2px; border-color:#1b4a95" type="submit" value="Speichern" /><br /><p style="color:red; font-style:italic; font-size:120%">Danach diesen Shortcode: <span style="color:black; font-weight:bold; font-style:normal">[book_bot_short_2]</span> in eine Seite (z. B.: Neue Seite mit Standardtemplate erstellen)<br /> oder in einen Artikel an einer Stelle deiner Wahl einfügen.</p>
