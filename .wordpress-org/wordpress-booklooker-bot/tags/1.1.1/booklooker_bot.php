...
<!--Hilfe visibility Ende-->
  ...
  <a onclick="toggleVisibility('bb_general_tip');" title="Für Hilfe klicken!" style="cursor:pointer;">Hilfe (Was wichtig ist.)</a>
  <div id="bb_general_tip" style="width:750px; font-style:italic; font-size:110%; text-align:left; display:none">
