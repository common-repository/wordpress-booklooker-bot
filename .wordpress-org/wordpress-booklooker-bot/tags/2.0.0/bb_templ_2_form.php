...
<!-- Hilfesequenz Ende-->               
  <p>
    <input name="booklook_uid2" value="<?php echo get_option('booklook_uid2'); ?>" type="text" />
  </p>              
  <p style="font-weight:bold; font-size:120%">Hier deine Produkt-ID (Kategorie) eintragen: 
  </p>
  <p>
    <input name="prod_id2" value="<?php echo get_option('prod_id2'); ?>" type="text" />
  </p>      
...
<textarea name="booklook_headline2" cols="30" rows="5"><?php echo get_option('booklook_headline2'); ?></textarea><br />      <h3>Hier enden die Optionen für die einfachste Version<br />
    <span style="font-style:italic">(150 Titel einer Produktart)
    </span></h3>             <h4>Anzeigelimit von bis</h4>    
  <?php echo $_POST['booklook_limitFrom2']; ?>  
<!-- Hilfesequenz-->             
...
<!-- Hilfesequenz Ende-->               
  <p>
    <input name="booklook_limitFrom2" value="<?php echo get_option('booklook_limitFrom2'); ?>" type="text" />
    <label>ab lfd. Nr.
    </label>
  </p>      
  <p>
    <input name="booklook_limit2" value="<?php echo get_option('booklook_limit2'); ?>" type="text" />
    <label>bis lfd. Nr.
    </label>
  </p>             
  ...
  <p style="color:red; font-style:italic; font-size:120%">Danach diesen Shortcode: 
    <span style="color:black; font-weight:bold; font-style:normal">[book_bot_short_2]
...
<!-- Hilfesequenz Ende-->        
  <p>
    <input type="radio" name="booklook_sparte2" value="sparte1ID"<?php echo $radio_checked_sparte1ID; ?> /> = Oberkategorie (sparte1ID)<br />      
    <input type="radio" name="booklook_sparte2" value="sparteID"<?php echo $radio_checked_sparteID; ?> /> = Unterkategorie (sparteID)<br />      
    <input type="radio" name="booklook_sparte2" value="keine"<?php echo $radio_checked_keine; ?> /> = keine (Standard)
  </p>      
  <p style="font-weight:bold; font-size:120%">Hier Nummer der Sparte1ID oder SparteID eintragen: 
    <p>
      <input name="booklook_sparteID2" value="<?php echo get_option('booklook_sparteID2'); ?>" type="text" />(Nummer der Sparte)<br />      
      <input style="color:#1b4a95; font-size:120%; font-weight:bold; background-color:#ececec; border-style:outline; border-width:2px; border-color:#1b4a95" type="submit" value="Speichern" /><br />
      <p style="color:red; font-style:italic; font-size:120%">Danach diesen Shortcode: 
        <span style="color:black; font-weight:bold; font-style:normal">[book_bot_short_2]
        </span> in eine Seite (z. B.: Neue Seite mit Standardtemplate erstellen)<br /> oder in einen Artikel an einer Stelle deiner Wahl einfügen.
