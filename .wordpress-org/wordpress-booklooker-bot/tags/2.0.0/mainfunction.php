...
//Auslesen
if(!isset($prod_ID)){
$xml_data = simplexml_load_file("https://secure.booklooker.de/interface/search.php?pid=6513412&uID=" . $uID . $limit_From . $limit_To);
}

if(isset($prod_ID)){
$xml_data = simplexml_load_file("https://secure.booklooker.de/interface/search.php?pid=6513412&uID=" . $uID . "&medium=" . $prod_ID . $limit_From . $limit_To);
// 3282283 fremd 3859792&setMediaType=0  ---------- Sabienes:   3119046
}
if($sparte=="sparte1ID"){
$xml_data = simplexml_load_file("https://secure.booklooker.de/interface/search.php?pid=6513412&uID=" . $uID . "&medium=" . $prod_ID . "&catID=" . $sparte1ID . $limit_From . $limit_To);
}
if($sparte=="sparteID"){
$xml_data = simplexml_load_file("https://secure.booklooker.de/interface/search.php?pid=6513412&uID=" . $uID . "&medium=" . $prod_ID . "&subCatID=" . $sparteID . $limit_From . $limit_To);
}
